    ...
    return (
        <Container className={classNames(
            ...
            <div className={classNames(
                ...
                오류 제보 또는 문의/피드백은 <a href='mailto:sorlti6952@gmail.com'>쿨핀</a>에게 알려주세요. thanks to <b className='text-cyan-300'>셜광</b>, <b className='text-red-300'>이상혁</b><br/> 
